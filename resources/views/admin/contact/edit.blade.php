            ...
            <form role="form" action="{{route('admin.contact.update',$contact->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="tel" name="phone" value="{{$contact->phone}}" class="form-control" id="phone" placeholder="Enter Phone">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="message" class="form-control" id="message" cols="30" rows="10">{{$contact->message}}</textarea>
                </div>
              </div>
              <!-- /.card-body -->
