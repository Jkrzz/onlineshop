            ...
            <form role="form" action="{{route('admin.post.update',$post->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" value="{{$post->name}}" class="form-control" id="name" placeholder="Enter Name">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price"  value="{{$post->price}}" class="form-control" id="price" placeholder="Enter Price">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number"  value="{{$post->instock}}" name="instock" class="form-control" id="instock" placeholder="Enter Instock">
                </div>
              </div>
              <!-- /.card-body -->
